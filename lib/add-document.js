...
function generateMetadataDocument (options) {
  ...
  var meta = {
    ...
    'args': {
      'parameter': {
        ...
        'Paragraph': options.Paragraph || 'Offl §13 jfr Fvl §13', // Codetable: Paragraph
        'ResponsibleEnterpriseRecno': options.responsibleEnterpriseRecno || '213419', // Recnr ansvarlig virksomhet
        'ResponsiblePersonRecno': options.responsiblePersonRecno || '214853',
  ...
  if (options.responsiblePerson) {
    delete meta.args.parameter.ResponsiblePersonRecno
  }
  return meta
}
